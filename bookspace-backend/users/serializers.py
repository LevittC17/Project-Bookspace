...
class CustomUserCreateSerializer(UserCreateSerializer):
    ...
    class Meta(UserCreateSerializer.Meta):
        ...
        fields = ('id', 'username', 'password', 'first_name', 'last_name', 'phone_number', 'sex',
                  'is_bookspace_owner', 'is_bookspace_manager', 'is_assistant_bookspace_manager', 'is_bookspace_worker')
...
class CustomUserSerializer(UserSerializer):
    ...
    class Meta(UserSerializer.Meta):
        model = User
        fields = ('id', 'username', 'first_name', 'last_name', 'phone_number', 'sex', 'is_bookspace_owner',
                  'is_bookspace_manager', 'is_assistant_bookspace_manager', 'is_bookspace_worker')
